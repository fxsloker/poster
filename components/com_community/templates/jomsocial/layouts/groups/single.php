...
if($showGroupDetails){
    ...
    <ul class="joms-focus__link">
        ...
        <?php if ($showEvents) { ?>
            <li class="half">
                <a href="<?php echo CRoute::_('index.php?option=com_community&view=events&task=dispaly&groupid=' . $group->id); ?>"><?php echo ($totalEvents == 1)
...
<div class="joms-main">
    ...
    <div class="joms-middlezone">
        ...
        <div id="joms-group--stream" class="joms-tab__content" style="<?php echo ($config->get('default_group_tab') == 0) ? '' : 'display:none'; ?>">
