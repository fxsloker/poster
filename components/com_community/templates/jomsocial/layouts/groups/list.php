...
<ul class="joms-list--card">
    ...
    <li class="joms-list__item <?php echo $group->approvals == COMMUNITY_PRIVATE_GROUP ? 'group-private' : 'group-public' ?>">
            ...
            <ul class="joms-list--table">
                ...
                <li>
                    <svg class="joms-icon" viewBox="0 0 18 18">
                        <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-bubbles"/>
                    </svg>
                ...
                <li>
                    <svg class="joms-icon" viewBox="0 0 16 16">
                        <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-bullhorn"/>
                    </svg>
                ...
                <li>
                    <svg class="joms-icon" viewBox="0 0 16 16">
                        <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-image"/>
                    </svg>
        ...
        <?php } else { ?>
            <span class="joms-list__permission">
                <svg class="joms-icon" viewBox="0 0 16 16">
                    <use xlink:href="<?php echo CRoute::getURI(); ?>#joms-icon-earth"/>
                </svg>
        ...
        <div class="joms-list__footer joms-padding">
            <div class="<?php echo CUserHelper::onlineIndicator($creator); ?>">
                <a class="joms-avatar" href="<?php echo CUrlHelper::userLink($creator->id);?>"><img src="<?php echo $creator->getAvatar();?>" alt="" data-author="<?php echo $creator->id; ?>" ></a>
            </div>
