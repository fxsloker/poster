...
define('utils/image',[],function() {
    ...
    function Preloader( images, callback ) {
        ...
        // sanitize url
        var rUrl = /^(http:|https:)?\/\/([a-z0-9-]+\.)+[a-z]{2,7}\/.*$/i;
...
function( $, BaseView, ajax, image, language ) {
    ...
    return BaseView.extend({
        ...
        fetch: function( text ) {
            var rUrl = /^(|.*\s)((https?:\/\/|www\.)([a-z0-9-]+\.)+[a-z]{2,7}(:\d+)?(\/.*)?)(\s.*|)$/i,
...
function(
    ...
    return BaseView.extend({
        ...
        render: function() {
            ...
            this.$options.find('li').on( 'click', $.bind( this.makeDefault, this ) );
        ...
        makeDefault: function( e ) {
            ...
            loading = this.$options.find('span > img');
