function cValidate() {
    this.message = "";
    this.REM = "info is required. Make sure it contains a valid value!";
    this.noticeTitle = "Notice";
    this.errorField = new Array();
    this.customMessage = "";
    this.JOINTEXT = ",";
    this.init = function() {
        joms.jQuery("#community-wrap form.community-form-validate :input.required").blur(function() {
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input.validate-profile-email").blur(function() {
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input.validate-profile-url").blur(function() {
            if ((joms.jQuery.trim(joms.jQuery(this).val()) !== "")) {
                if (cvalidate.validateElement(this)) {
                    cvalidate.markValid(this);
                } else {
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input.validate-country").change(function() {
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input.validate-custom-date").blur(function() {
            if (cvalidate.validateElement(this)) {
                cvalidate.markValid(this);
            } else {
                cvalidate.markInvalid(this);
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input.validateSubmit").click(function() {
            if (cvalidate.validateForm()) {
                ...
                joms.jQuery("#community-wrap form.community-form-validate :input.required[value='']").each(function(i) {
                    cvalidate.markInvalid(this);
                });
                return false;
            }
    ...
    this.validateElement = function(el) {
        ...
        if (elType == "text" || elType == "password" || joms.jQuery(el).is("textarea")) {
            if (elValue == "") {
                ...
                if (joms.jQuery(el).hasClass("validate-profile-url")) {
                    ...
                    if (url.match("http://")) {
                        ...
                        joms.jQuery(el).prev("select").find("option").removeAttr("selected").filter('[value="http://"]').attr("selected", "selected");
                    }
                    if (url.match("https://")) {
                        url = url.replace("https://", "");
                        joms.jQuery(el).prev("select").find("option").removeAttr("selected").filter('[value="https://"]').attr("selected", "selected");
                    }
            ...
            if (joms.jQuery(el).attr("type") == "checkbox") {
                ...
                if (joms.jQuery(el).attr("type") == "radio") {
                    ...
                    if (joms.jQuery(el).is("select")) {
                        if (joms.jQuery(el).children(":selected").length == 0) {
                            isValid = false;
                        } else {
                            joms.jQuery(el).children(":selected").each(function() {
                        ...
                        if (joms.jQuery(el).attr("type") == "select-multiple") {
                            if (joms.jQuery(el).children(":selected").length == 0) {
                                isValid = false;
                            }
                            if (isValid == false) {
    ...
    this.validateForm = function() {
        var isValid = true;
        this.errorField = new Array();
        joms.jQuery("#community-wrap form.community-form-validate :input.required").each(function() {
            if (!cvalidate.validateElement(this)) {
                isValid = false;
            }
        });
        joms.jQuery("#community-wrap form.community-form-validate :input.validate-profile-email").each(function() {
            if ((joms.jQuery.trim(joms.jQuery(this).val()) != "")) {
                if (!cvalidate.validateElement(this)) {
                    isValid = false;
                }
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input[class*=minmax]").each(function() {
        ...
        joms.jQuery("#community-wrap form.community-form-validate :input.validate-profile-url").each(function() {
            if ((joms.jQuery.trim(joms.jQuery(this).val()) != "")) {
                if (!cvalidate.validateElement(this)) {
                    isValid = false;
                }
    ...
    b.fn.password_strength = function(c) {
        ...
        return this.each(function() {
            if (d.container) {
                ...
                var e = b("<span/>").attr("class", "jsPasswordStrength");
                b(this).after(e);
            }
            b(this).keyup(function() {
                ...
                if (g.length > 0) {
                    ...
                    var f = "jsPasswordStrength_" + h;
                    if (!e.hasClass(f) && h in d.texts) {
                        e.text(d.texts[h]).attr("class", "jsPasswordStrength " + f);
                        if (h == 1) {
                    ...
                    e.text("").attr("class", "jsPasswordStrength");
                }
            });
        });
    };
