...
function joms_init_toolkit() {
    ...
    ! function(a) {
        "function" == typeof define && define.amd && false ? define("picker", ["jquery"], a) : this.Picker = a(jQuery)
    }(function(a) {
        function b(d, e, g, h) {
            function i() {
            ...
            function k() {
                s.$root.on({
                    ...
                    var c = a(this),
                        e = c.data(),
                        f = c.hasClass(p.navDisabled) || c.hasClass(p.disabled),
                        g = document.activeElement;
                    g = g && (g.type || g.href) && g, (f || g && !a.contains(s.$root[0], g)) && d.focus(), e.nav && !f ? s.set("highlight", s.component.item.highlight, {
                        nav: e.nav
                    }) : b._.isInteger(e.pick) && !f ? s.set("select", e.pick).close(!0) : e.clear && s.clear().close(!0)
                }), c(s.$root[0], "hidden", !0)
            }
            ...
            function m(a) {
                a.stopPropagation(), "focus" == a.type && (s.$root.addClass(p.focused), c(s.$root[0], "selected", !0)), s.open(), setTimeout(function() {
                    var ios = /iphone|ipad|ipod/i;
                    ios.test(navigator.userAgent) && s.$node.blur()
                }, 100)
            }
            if (!d) return b;
            var n = {
                    id: d.id || "P" + Math.abs(~~(Math.random() * new Date))
                },
                o = g ? a.extend(!0, {}, g.defaults, h) : h || {},
                p = a.extend({}, b.klasses(), o.klass),
                q = a(d),
                r = function() {
                    return this.start()
                },
    ...
    ! function(a) {
        "function" == typeof define && define.amd && false ? define(["picker", "jquery"], a) : a(Picker, jQuery)
    }(function(a, b) {
        function c(a, b) {
            var c = this,
                d = a.$node[0].value,
        ...
        c.prototype.set = function(a, b, c) {
            ...
            }), [h.yyyy || h.yy, +(h.mm || h.m) - 1, h.dd || h.d])
