...
?>
	<form action="<?php echo JRoute::_('index.php?option=com_form2content&task=users.display&layout=modal&view=users&tmpl=component&groups='.JFactory::getApplication()->input->get('groups', '', 'BASE64').'&excluded='.JFactory::getApplication()->input->get('excluded', '', 'BASE64'));?>" method="post" name="adminForm" id="adminForm">
